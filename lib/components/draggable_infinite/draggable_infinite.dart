...
class _InfiniteDraggableSliderState extends State<InfiniteDraggableSlider>
  ...
  late int index;
  static const inclineLeft = -math.pi * .05;
  static const inclineRight = math.pi * .05;
  ...
  Offset getOffset(int stackIndex) =>
      {
        ...
        1: Offset(ui.lerpDouble(-35, 35, controller.value)!, 30),
        2: const Offset(20, 30) * (1 - controller.value),
        3: const Offset(70, 30) * (1 - controller.value),
      }[stackIndex] ??
  ...
  double getAngle(int stackIndex) =>
      {
        ...
        2: ui.lerpDouble(0, 0, controller.value)!,
        3: ui.lerpDouble(inclineRight, 0, controller.value)!,
      }[stackIndex] ??
